...
class SimParams:
    def __init__(self):
        ...
        self.dt = 2.0e-6
        self.t_end = 0.015
        self.max_vel_rot = 6000.0
        self.max_force = 2000.0
        self.gif_fps = 30
        self.anim_duration = 8.0
...
class CamSystemSimulation:
    ...
    def _init_state(self):
        ...
        self.history = {k: [] for k in ['t', 'c_x', 'c_y', 'c_theta', 'w_theta', 'f_input', 'f_contact_x']}
    ...
    def setup_animation_figure(self):
        ...
        cx = np.array(self.history['c_x']) * 1000
        cy = (np.array(self.history['c_y']) - self.C0[1]) * 1000
